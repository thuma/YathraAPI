...
try:
    response = http_client.fetch('https://raw.githubusercontent.com/thuma/Transit-Stop-Identifier-Conversions-Sweden/master/kalmarlanstrafik-gtfs.csv')
...
class Handler(tornado.web.RequestHandler):
	...
	def get(self):
		...
		req +='&MapParams='
		self.url = 'http://thuma.github.io/gettopost.html#http://193.45.213.123/kalmar/querypage_adv.aspx&&&'+req
		self.myhttprequest = tornado.httpclient.HTTPRequest('http://193.45.213.123/kalmar/querypage_adv.aspx', method='POST', headers=None, body=req) 
