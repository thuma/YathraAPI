...
class Handler(tornado.web.RequestHandler):
	...
	def searchdone(self, response):
		...
		try:
			...
			outdata['url'] = 'http://thuma.github.io/gettopost.html#http://masexpressen.se/&&&from='+stops[self.get_argument('from')]+'&to='+stops[self.get_argument('to')]+'&date_outbound='+self.get_argument('date')+'&date_return='+self.get_argument('date')+'&type_15=1&type_16=0&type_20=0&type_17=0&type_18=0&btn_continue=S%F6k+avg%E5ngar'
